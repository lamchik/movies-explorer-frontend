...
function ProfileHeader () {
    ...
    const buttonClassName = (
        `burger-menu ${openBurgerMenu ? 'burger-menu_active' : 'burger-menu_invisible'}`
    )
        ...
        <div className="header-profile">
            ...
            <div className={`"burger-menu" ${buttonClassName}`}>
                <div className="burger-menu__nav">
                    <NavLink  className="burger-menu__nav-text header-profile__link-text" to="/">Главная</NavLink>
                    <NavLink className="burger-menu__nav-text header-profile__link-text" to="/movies" activeClassName="nav__link_active">Фильмы</NavLink>
                    <NavLink className="burger-menu__nav-text header-profile__link-text" to="/saved-movies" activeClassName="nav__link_active">Сохранённые фильмы</NavLink>
                </div>
                <div className="burger-menu__nav-profile-wrap">
                    <Link className="burger-menu__nav-profile header-profile__user-text" to="/profile">Аккаунт</Link>

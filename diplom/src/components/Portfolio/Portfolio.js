  ...
  return (
    <div className="portfolio-wrap">
      ...
      <div className="portfolio__name">
        ...
        <a className="portfolio__link" href="https://lamchik.github.io/russian-travel/" target="blank">
          ↗
        </a>
      </div>
      ...
      <div className="portfolio__name">
        ...
        <a className="portfolio__link" href="https://lamchik.github.io/mesto/" target="blank">
          ↗
        </a>
      </div>
    </div>
